//A partial function is a trait that when implemented can be used
// as building blocks to determine a solution.
...
val whatToDo2 = doubleEvens2 orElse tripleOdds2 //Here we
// chain the partial functions together
whatToDo2(3)
whatToDo2(4)

//The result of partial functions can have
// an andThen function added to the end of the chain:
...
val whatToDo3 = doubleEvens3 orElse tripleOdds3 andThen addFive //Here we chain the partial functions together
whatToDo3(3)
whatToDo3(4)

// andThen can be used to continue onto
